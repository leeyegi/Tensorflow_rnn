...
x_train, x_test, y_train, y_test = train_test_split(reshaped_segments_2, reshaped_labels, test_size=0.2, random_state=42)
print(x_train.shape)
print(y_train.shape)
...
W1 = tf.Variable(tf.random_normal([300, 256]))
...
W5 = tf.Variable(tf.random_normal([128, 16]))
